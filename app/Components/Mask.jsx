...
export default function Mask({
    ...
    return (
      ...
      >
        <motion.div
          className="w-full h-full flex items-center justify-center text-6xl absolute bg-white bg-grid-white/[0.2] text-black [mask-image:url(/mask.svg)] [mask-size:40px] [mask-repeat:no-repeat]"
          animate={{
